...
allowed-tools: ["Read"]
---
<!-- imported from anthropics/claude-code@2bb6069 -- plugins/hookify/commands/help.md (renamed from help) -->

> **Not active in this project.** Only hookify's commands, agent and authoring skill were
> imported -- the plugin's own hook handlers, which evaluate the rules, were not. Rules this
> command writes will sit inert until you run `/plugin marketplace add anthropics/claude-code`
> then `/plugin install hookify`. Tell the user this before writing a rule for them.
...
For more examples, check the `.claude/skills/hookify-rules/examples/` directory.
