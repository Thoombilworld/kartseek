...
---
<!-- imported from anthropics/claude-code@2bb6069 -- plugins/hookify/commands/list.md (renamed from list) -->
...
Check `.claude/skills/hookify-rules/examples/` for example rule files.
```
