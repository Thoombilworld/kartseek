...
async function seed() {
  ...
  const productDefs = [
    ...
    {
      name: 'Apple iPad Pro 12.9" M2 Chip (256GB)',
      slug: 'ipad-pro-m2-256gb',
      gtin: 'ASIN-B0BJLF1JNH',
      brand: 'apple',
      category: 'mobiles-tablets',
      subcategory: 'tablets',
      mrp: 5450,
    ...
    },
    {
      ...
      slug: 'samsung-20000mah-powerbank',
      gtin: 'ASIN-B0D8PWRBNK',
      brand: 'samsung',
      category: 'mobiles-tablets',
    ...
    },
    {
      ...
      slug: 'apple-20w-usbc-charger',
      gtin: 'ASIN-B09J1CHG20',
      brand: 'apple',
      category: 'mobiles-tablets',
      subcategory: 'chargers-and-cables',
      mrp: 85,
      price: 65,
      rating: 4.5,
      reviews: 3200,
    ...
    // Electronics
    {
      name: 'MacBook Air M3 (8GB, 256GB SSD)',
      slug: 'macbook-air-m3-256gb',
      gtin: 'ASIN-B0CX23V2RE',
      brand: 'apple',
    ...
    {
      name: 'Dell XPS 13 Plus (16GB, 512GB SSD)',
      slug: 'dell-xps-13-plus',
      gtin: 'ASIN-B0CXPS13DL',
      brand: 'dell',
      category: 'electronics',
      subcategory: 'laptops',
      mrp: 6950,
    ...
    },
    {
      ...
      slug: 'sony-wh1000xm5',
      gtin: 'ASIN-B09XS7JWHH',
      brand: 'sony',
      category: 'electronics',
      subcategory: 'headphones-and-earbuds',
      mrp: 1500,
      price: 1100,
      rating: 4.8,
      reviews: 8200,
    ...
    // Fashion
    {
      ...
      slug: 'nike-drifit-mens-tshirt',
      gtin: 'ASIN-B0DKNKFASH',
      brand: 'nike',
      category: 'fashion',
    ...
    {
      name: "Puma Women's Running Jacket",
      slug: 'puma-womens-running-jacket',
      gtin: 'ASIN-B0DPUMAWJK',
      brand: 'puma',
      category: 'fashion',
    ...
    {
      name: "Nike Boys' Sportswear T-Shirt",
      slug: 'nike-boys-sportswear-tshirt',
      gtin: 'ASIN-B0DNKBOYTS',
      brand: 'nike',
      category: 'fashion',
    ...
    },
    {
      ...
      slug: 'puma-mens-track-pants',
      gtin: 'ASIN-B0DPMTRPNT',
      brand: 'puma',
      category: 'fashion',
    ...
    {
      name: 'Nike Essential Running Shorts',
      slug: 'nike-essential-running-shorts',
      gtin: 'ASIN-B0DNKRUNSH',
      brand: 'nike',
      category: 'fashion',
      subcategory: 'sportswear',
      mrp: 80,
    ...
    {
      name: 'IKEA HEMNES Bed Frame, Queen',
      slug: 'ikea-hemnes-bed-queen',
      gtin: 'ASIN-B0CIKEAHMN',
      brand: 'ikea',
      category: 'home-kitchen',
      subcategory: 'bedding',
      mrp: 1100,
    ...
    {
      name: 'Nike Yoga Mat Premium (5mm)',
      slug: 'nike-yoga-mat-5mm',
      gtin: 'ASIN-B0DNKYOGMT',
      brand: 'nike',
      category: 'sports',
    ...
    {
      name: 'Samsung 70L Front-Load Washer',
      slug: 'samsung-front-load-washer',
      gtin: 'ASIN-B0CSSMFLWM',
      brand: 'samsung',
      category: 'appliances',
    ...
    },
    {
      ...
      slug: 'lg-260l-double-door-fridge',
      gtin: 'ASIN-B0CLGDDFRG',
      brand: 'lg',
      category: 'appliances',
    ...
    },
    {
      ...
      slug: 'samsung-1-5ton-split-ac',
      gtin: 'ASIN-B0CSSSPLAC',
      brand: 'samsung',
      category: 'appliances',
    ...
    {
      name: 'Dell Inspiron 15 (8GB, 512GB)',
      slug: 'dell-inspiron-15-8-512',
      gtin: 'ASIN-B0CDL15I8G',
      brand: 'dell',
      category: 'electronics',
      subcategory: 'laptops',
      mrp: 2850,
    ...
    },
    {
      ...
      slug: 'bose-soundlink-revolve-plus-2',
      gtin: 'ASIN-B099TLRGRV',
      brand: 'bose',
      category: 'electronics',
    ...
    },
    {
      ...
      slug: 'samsung-tab-s9-fe-128',
      gtin: 'ASIN-B0CKSTABS9',
      brand: 'samsung',
      category: 'mobiles-tablets',
      subcategory: 'tablets',
      mrp: 1950,
    ...
    {
      name: "Nike Women's Dri-FIT Running Top",
      slug: 'nike-womens-drifit-running-top',
      gtin: 'ASIN-B0DNKWDFRT',
      brand: 'nike',
      category: 'fashion',
      subcategory: 'womens-clothing',
      mrp: 120,
    ...
    {
      name: 'Puma Unisex Running Backpack',
      slug: 'puma-unisex-running-backpack',
      gtin: 'ASIN-B0DPMURBKP',
      brand: 'puma',
      category: 'sports',
    ...
    {
      name: 'IKEA MALM Desk, Oak',
      slug: 'ikea-malm-desk-oak',
      gtin: 'ASIN-B0CIKEAMLM',
      brand: 'ikea',
      category: 'home-kitchen',
      subcategory: 'decor',
      mrp: 390,
    ...
    },
    {
      ...
      slug: 'lg-32-fhd-monitor',
      gtin: 'ASIN-B0CLG32MON',
      brand: 'lg',
      category: 'appliances',
      subcategory: 'tvs',
      mrp: 830,
  ...
  for (const p of productDefs) {
    ...
    `,
      [
        ...
        p.name,
        p.slug,
        `${p.name} — Buy online at best price`,
        brandMap[p.brand],
        categoryId,
        subcategoryId,
        actualSellerId,
  ...
  if (doomed.rowCount > 0) {
    ...
    for (const [table, column] of [
      ...
      await client
        .query(`DELETE FROM marketplace.${table} WHERE ${column} = ANY($1::uuid[])`, [ids])
        .catch(() => {
    ...
    `,
      ...
      .catch(() => {});
    await client
      .query(`DELETE FROM marketplace.product_questions WHERE product_id = ANY($1::uuid[])`, [ids])
      .catch(() => {});
  ...
  const orphanBrands = await client
    .query(
      `
