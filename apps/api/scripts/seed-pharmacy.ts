...
const ds = new DataSource({
  ...
  schema: 'pharmacy',
  entities: [path.join(__dirname, '../apps/pharmacy-service/src/entities/*.entity.{ts,js}')],
  synchronize: true,
  logging: false,
});

import { PharmacyStore, PharmacyStoreStatus } from '../apps/pharmacy-service/src/entities/pharmacy-store.entity';
import { PharmacyCategory } from '../apps/pharmacy-service/src/entities/pharmacy-category.entity';
import { PharmacyItem, DosageForm } from '../apps/pharmacy-service/src/entities/pharmacy-item.entity';
import { PharmacyOrder, PharmacyOrderStatus, PharmacyOrderType, PharmacyPaymentMethod, PharmacyPaymentStatus } from '../apps/pharmacy-service/src/entities/pharmacy-order.entity';
import { Prescription, PrescriptionStatus } from '../apps/pharmacy-service/src/entities/prescription.entity';
import { PharmacyReview } from '../apps/pharmacy-service/src/entities/pharmacy-review.entity';
import { PharmacyStaff, PharmacyStaffRole } from '../apps/pharmacy-service/src/entities/pharmacy-staff.entity';
import { PharmacyPromotion, PharmacyPromoType } from '../apps/pharmacy-service/src/entities/pharmacy-promotion.entity';
