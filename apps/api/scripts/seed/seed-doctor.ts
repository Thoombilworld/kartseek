...
const SPECIALTIES_DATA = [
  { name: 'General Physician', icon: '🩺', description: 'Primary care and internal medicine', sortOrder: 1 },
  ...
  { name: 'Orthopedics', icon: '🦴', description: 'Bones, joints, and musculoskeletal system', sortOrder: 4 },
  ...
  { name: 'Gynecology', icon: '🤰', description: "Women's health and reproductive care", sortOrder: 9 },
  { name: 'ENT', icon: '👂', description: 'Ear, nose, and throat', sortOrder: 10 },
  { name: 'Urology', icon: '💧', description: 'Urinary tract and male reproductive health', sortOrder: 11 },
  { name: 'Oncology', icon: '🎗️', description: 'Cancer diagnosis and treatment', sortOrder: 12 },
];

const HOSPITALS_DATA = [
  {
    name: 'Mumbai Hospital', city: 'Mumbai', location: 'Worli, Mumbai',
    address: 'Linking Road, Worli, Mumbai', latitude: -1.2961, longitude: 36.8120,
    rating: 4.9, ratingCount: 1250, doctorCount: 45,
    specialties: ['Cardiology', 'Orthopedics', 'Neurology', 'General Physician', 'Pediatrics'],
    hospitalType: 'multi-speciality', status: 'active',
    phone: '+91 20 284 5000', email: 'info@Mumbaihospital.org',
    ...
    hasEmergency: true, hasPharmacy: true, hasLab: true, hasAmbulance: true, bedCount: 350,
    coverImage: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=800&q=80',
  },
  {
    name: 'Aga Khan University Hospital', city: 'Mumbai', location: 'Bandra, Mumbai',
    address: '3rd Bandra Avenue, Mumbai', latitude: -1.2580, longitude: 36.8176,
    rating: 4.8, ratingCount: 980, doctorCount: 38,
    specialties: ['General Physician', 'Oncology', 'Neurology', 'Gynecology', 'Dermatology'],
    hospitalType: 'super-speciality', status: 'active',
    phone: '+91 20 366 2000', email: 'info@aku.edu',
    ...
    hasEmergency: true, hasPharmacy: true, hasLab: true, hasAmbulance: true, bedCount: 280,
    coverImage: 'https://images.unsplash.com/photo-1586773860418-d37222d8fce3?w=800&q=80',
  },
  {
    name: 'MP Shah Hospital', city: 'Mumbai', location: 'Shivachi Rd, Mumbai',
    address: 'Hill Road, Bandra, Mumbai', latitude: -1.2615, longitude: 36.8162,
    rating: 4.7, ratingCount: 720, doctorCount: 25,
    specialties: ['General Physician', 'Dental', 'Orthopedics', 'ENT', 'Ophthalmology'],
    hospitalType: 'general', status: 'active',
    phone: '+91 20 429 9999', email: 'info@mpshah.org',
    ...
    hasEmergency: true, hasPharmacy: true, hasLab: true, hasAmbulance: false, bedCount: 180,
...
const CLINICS_DATA = [
  {
    name: 'HealthFirst Clinic', city: 'Mumbai', location: 'Andheri West, Mumbai',
    address: 'SV Road, Andheri West, Mumbai', latitude: -1.2636, longitude: 36.8028,
    rating: 4.6, ratingCount: 320, doctorCount: 8,
    specialties: ['General Physician', 'Dermatology', 'Pediatrics'],
    status: 'active', phone: '+91 710 123 456', email: 'hello@healthfirst.co.in',
  ...
  {
    name: 'MediCare Plus', city: 'Mumbai', location: 'Juhu, Mumbai',
    address: 'Bandra West Road, Mumbai', latitude: -1.3190, longitude: 36.7110,
    rating: 4.5, ratingCount: 210, doctorCount: 5,
    specialties: ['Dental', 'Ophthalmology', 'ENT'],
    status: 'active', phone: '+91 722 456 789', email: 'info@medicareplus.co.in',
  ...
  {
    name: 'City Wellness Hub', city: 'Delhi', location: 'Colaba, Delhi',
    address: 'Carter Road, Colaba, Delhi', latitude: -4.0268, longitude: 39.6950,
    rating: 4.4, ratingCount: 180, doctorCount: 6,
    specialties: ['General Physician', 'Gynecology', 'Urology'],
    status: 'active', phone: '+91 733 789 012', email: 'hello@citywellness.co.in',
...
const DOCTORS_DATA = [
  { name: 'Dr. Amara Okonkwo', specialty: 'General Physician', qualifications: ['MBBS', 'MD'], rating: 4.8, ratingCount: 342, experience: 12, fee: 1500, videoFee: 800, consultMode: 'both', languages: ['English', 'Hindi'], hospitalIndex: 0, providerType: 'hospital', city: 'Mumbai', about: 'Specialist in internal medicine and preventive healthcare.', profileImage: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80', gender: 'female' },
  { name: 'Dr. Zara Ahmed', specialty: 'Pediatrics', qualifications: ['MBBS', 'DCH'], rating: 4.9, ratingCount: 289, experience: 8, fee: 2000, videoFee: 1200, consultMode: 'both', languages: ['English', 'Arabic'], hospitalIndex: 0, providerType: 'hospital', city: 'Mumbai', about: 'Child health specialist with focus on developmental pediatrics.', profileImage: 'https://images.unsplash.com/photo-1594824476967-48c8b964ac31?w=400&q=80', gender: 'female' },
  { name: 'Dr. James Ochieng', specialty: 'Cardiology', qualifications: ['MBBS', 'MD', 'DM Cardiology'], rating: 4.9, ratingCount: 456, experience: 15, fee: 3000, videoFee: 2000, consultMode: 'both', languages: ['English', 'Hindi'], hospitalIndex: 1, providerType: 'hospital', city: 'Mumbai', about: 'Senior interventional cardiologist with 15 years of experience.', profileImage: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&q=80', gender: 'male' },
  { name: 'Dr. Grace Wanjiku', specialty: 'Dermatology', qualifications: ['MBBS', 'MD Dermatology'], rating: 4.7, ratingCount: 198, experience: 6, fee: 1200, videoFee: 700, consultMode: 'both', languages: ['English', 'Hindi'], clinicIndex: 0, providerType: 'clinic', city: 'Mumbai', about: 'Skin care specialist focused on cosmetic and medical dermatology.', profileImage: 'https://images.unsplash.com/photo-1651008376811-b90baee60c1f?w=400&q=80', gender: 'female' },
  { name: 'Dr. Raj Patel', specialty: 'Orthopedics', qualifications: ['MBBS', 'MS Ortho'], rating: 4.6, ratingCount: 178, experience: 10, fee: 2500, videoFee: 1500, consultMode: 'in-person', languages: ['English', 'Hindi', 'Hindi'], hospitalIndex: 2, providerType: 'hospital', city: 'Mumbai', about: 'Sports medicine and joint replacement specialist.', profileImage: 'https://images.unsplash.com/photo-1622253692010-333f2da6031d?w=400&q=80', gender: 'male' },
  { name: 'Dr. Fatima Hassan', specialty: 'Gynecology', qualifications: ['MBBS', 'MD OB/GYN'], rating: 4.8, ratingCount: 267, experience: 9, fee: 1800, videoFee: 1000, consultMode: 'both', languages: ['English', 'Arabic', 'Hindi'], providerType: 'independent', city: 'Mumbai', about: "Women's health specialist with expertise in high-risk pregnancies.", profileImage: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&q=80', gender: 'female' },
];
...
async function seed() {
  ...
  const hospitals = hospitalRepo.create(
    HOSPITALS_DATA.map(h => ({ ...h, slug: slug(h.name), isOpen: true }) as any),
  );
  ...
  const clinics = clinicRepo.create(
    CLINICS_DATA.map(c => ({ ...c, slug: slug(c.name) }) as any),
  );
  ...
  console.log(`   ✅ ${totalDepts} departments seeded across ${savedHospitals.length} hospitals.\n`);

  // ── 5. Seed Doctors ──────────────────────────────────────────────────────
  console.log('👨‍⚕️ Seeding doctors...');
  const doctorEntities = doctorRepo.create(
    DOCTORS_DATA.map(d => {
      const hospitalId = d.hospitalIndex !== undefined ? savedHospitals[d.hospitalIndex].id : undefined;
      const clinicId = (d as any).clinicIndex !== undefined ? savedClinics[(d as any).clinicIndex].id : undefined;
      const hospital = hospitalId ? savedHospitals[d.hospitalIndex!] : undefined;
      const clinic = clinicId ? savedClinics[(d as any).clinicIndex] : undefined;
      return {
        name: d.name,
        slug: slug(d.name),
        ...
        isAvailable: true,
        consultMode: d.consultMode as any,
        status: 'active' as const,
        providerType: d.providerType as any,
        city: d.city,
        gender: d.gender,
        hospitalId,
        clinicId,
  ...
  for (const doctor of savedDoctors) {
    ...
    for (let day = 1; day <= 5; day++) {
      const morningSlot = availabilityRepo.create({
        ...
        isActive: true,
        consultMode: doctor.consultMode as any,
        locationType: doctor.providerType as any,
  ...
  console.log(`   ✅ ${totalSlots} availability slots seeded across ${savedDoctors.length} doctors.\n`);

  // ── 7. Seed Sample Appointments ──────────────────────────────────────────
  console.log('📋 Seeding appointments...');
  const appointmentsData = [
    { doctorIdx: 0, customerId: 'CUST-001', patientName: 'John Sharma', date: '2026-07-15', timeSlot: '09:00', type: 'in-clinic' as const, status: 'CONFIRMED' as const, symptoms: 'Recurring headaches' },
    { doctorIdx: 2, customerId: 'CUST-002', patientName: 'Mary Wambui', date: '2026-07-15', timeSlot: '10:30', type: 'in-clinic' as const, status: 'CONFIRMED' as const, symptoms: 'Chest pain during exercise' },
    { doctorIdx: 1, customerId: 'CUST-003', patientName: 'Ali Mohamed', date: '2026-07-14', timeSlot: '14:00', type: 'video' as const, status: 'COMPLETED' as const, symptoms: 'Child fever' },
    { doctorIdx: 3, customerId: 'CUST-004', patientName: 'Sarah Njeri', date: '2026-07-16', timeSlot: '11:00', type: 'in-clinic' as const, status: 'PENDING' as const, symptoms: 'Skin rash on arms' },
    { doctorIdx: 5, customerId: 'CUST-005', patientName: 'Amina Ali', date: '2026-07-17', timeSlot: '09:30', type: 'video' as const, status: 'CONFIRMED' as const, symptoms: 'Prenatal checkup' },
  ];
