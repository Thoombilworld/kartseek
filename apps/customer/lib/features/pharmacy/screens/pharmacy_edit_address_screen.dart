...
class PharmacyEditAddressScreen extends StatefulWidget {
  final String addressId;
  const PharmacyEditAddressScreen({super.key, this.addressId = ''});
  @override
  State<PharmacyEditAddressScreen> createState() =>
      _PharmacyEditAddressScreenState();
}

class _PharmacyEditAddressScreenState extends State<PharmacyEditAddressScreen> {
  final _formKey = GlobalKey<FormState>();
  final _labelCtrl = TextEditingController(text: 'My Home');
  final _line1Ctrl = TextEditingController(text: 'Tower B, Prestige Heights');
  final _line2Ctrl =
      TextEditingController(text: 'Near Metro Station, Sector 12');
  final _cityCtrl = TextEditingController(text: 'Hyderabad');
  final _stateCtrl = TextEditingController(text: 'Telangana');
  final _pinCtrl = TextEditingController(text: '500032');
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(
                    color: AppTheme.pharmacyColor.withValues(alpha: 0.15)),
              ),
              child: Stack(
            ...
            _field(_labelCtrl, 'Label', 'e.g. My Home', Icons.bookmark_outline),
            ...
            Row(children: [
              Expanded(
                  child: _field(
                      _pinCtrl, 'PIN *', 'Code', Icons.pin_drop_outlined,
