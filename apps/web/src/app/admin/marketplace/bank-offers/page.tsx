...
const BANK_OFFERS = [
  ...
  {
    id: 'BO-1002',
    title: '₹500 Cashback on SBI Debit Card',
    bankName: 'SBI',
    cardType: 'DEBIT',
    cardNetwork: 'RUPAY',
    discountType: 'FLAT',
  ...
  {
    id: 'BO-1003',
    title: '15% Off with ICICI EMI on Electronics',
    bankName: 'ICICI Bank',
    cardType: 'EMI',
    cardNetwork: 'VISA',
    discountType: 'PERCENTAGE',
  ...
  {
    id: 'BO-1004',
    title: 'Flat ₹200 Off on Paytm Wallet',
    bankName: 'Paytm',
    cardType: 'WALLET',
    cardNetwork: 'ALL',
    discountType: 'FLAT',
    ...
    minOrderValue: 1000,
    logoUrl: '',
    applicableCategories: ['Grocery', 'Pharmacy'],
    applicableCountries: ['India'],
  ...
  {
    id: 'BO-1005',
    title: '5% Off with Barclays Credit Card',
    bankName: 'Barclays',
    cardType: 'CREDIT',
    ...
    logoUrl: '',
    applicableCategories: ['All'],
    applicableCountries: ['UK', 'UAE'],
    totalUsageLimit: 30000,
    perUserLimit: 2,
    usageCount: 0,
  ...
  {
    id: 'BO-1006',
    title: '₹1000 Off on Axis Bank Credit Card',
    bankName: 'Axis Bank',
    cardType: 'CREDIT',
    cardNetwork: 'VISA',
    discountType: 'FLAT',
    ...
    minOrderValue: 8000,
    logoUrl: '',
    applicableCategories: ['Electronics', 'Home & Kitchen'],
    applicableCountries: ['India'],
    totalUsageLimit: 15000,
    perUserLimit: 1,
    usageCount: 7500,
...
export default function BankOffersPage() {
  ...
  const {
    ...
    toast,
    showToast,
  } = useAdminData(() => adminMarketplaceApi.getBankOffers(country), [country]);
  ...
  } = useMarketplaceRegionFilter(BANK_OFFERS);
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-slate-500 text-sm mt-1">
            {isRegionFiltered ? `${regionLabel} — ` : ''}Manage bank partnerships, card discounts,
            EMI offers, and wallet cashback displayed across the customer app & website.
          </p>
        </div>
        <button
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          },
          {
            ...
            count: totalRedemptions.toLocaleString('en-IN'),
            color: 'bg-blue-100 text-blue-600',
            Icon: TrendingUp,
          },
          {
            label: 'Partner Banks',
            count: new Set(regionFiltered.map((o) => o.bankName)).size,
      ...
      <div className="flex gap-2 flex-wrap">
        {['All', 'Active', 'Paused', 'Draft', 'Expired', 'Archived'].map((s) => (
          <button
            ...
            className={`px-3 py-2 text-xs font-bold rounded-xl border transition-colors ${statusFilter === s ? 'bg-blue-600 text-white border-blue-600' : 'bg-white text-slate-600 border-slate-200 hover:border-blue-300'}`}
          >
            {s}
          </button>
        ))}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="divide-y divide-slate-100">
              {filtered.map((o) => {
                const usagePercent = o.totalUsageLimit
                  ? Math.round((o.usageCount / o.totalUsageLimit) * 100)
                  : 0;
                return (
                  <tr key={o.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="px-5 py-4 text-center">
                      <span
                        className={`text-xs font-bold px-2 py-1 rounded-lg ${CARD_TYPE_STYLES[o.cardType] || 'bg-slate-100 text-slate-600'}`}
                      >
                        {o.cardType}
                      </span>
                    </td>
                    <td className="px-5 py-4 text-center">
                      <span className="text-lg font-black text-emerald-700">
                        {o.discountType === 'PERCENTAGE'
                          ? `${o.discountValue}%`
                          : `₹${o.discountValue.toLocaleString('en-IN')}`}
                      </span>
                      <p className="text-[10px] text-slate-400">
                        {o.discountType === 'PERCENTAGE' ? 'Percentage' : 'Flat'}
                      </p>
                    </td>
                    <td className="px-5 py-4 text-center font-bold text-slate-700">
                      ₹{o.minOrderValue.toLocaleString('en-IN')}
                    </td>
                    <td className="px-5 py-4 text-center font-bold text-slate-700">
                      ₹{o.maxDiscount.toLocaleString('en-IN')}
                    </td>
                    ...
                    <td className="px-5 py-4 text-center">
                      <p className="font-bold text-slate-800">
                        {o.usageCount.toLocaleString('en-IN')}
                      </p>
                      <div className="w-16 mx-auto mt-1 bg-slate-100 rounded-full h-1.5">
                        <div
                          className={`h-1.5 rounded-full ${usagePercent >= 80 ? 'bg-red-500' : usagePercent >= 50 ? 'bg-amber-500' : 'bg-emerald-500'}`}
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., 10% Instant Discount with HDFC Credit Card"
                />
              </div>
              <div>
                <label
