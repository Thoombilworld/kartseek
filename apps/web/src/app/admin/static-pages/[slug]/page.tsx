  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 4,
        content:
          'All data is encrypted in transit (TLS 1.3) and at rest (AES-256). We implement industry-standard security measures including firewalls, intrusion detection systems, and regular security audits. Access to personal data is restricted to authorized personnel on a need-to-know basis.',
        isEditing: false,
      },
      {
        id: 'prv-5',
    ...
    sections: [
      {
        ...
        order: 1,
        content:
          'You must be at least 18 years old to create an account. You agree to provide accurate, current, and complete information during registration and to update such information to keep it accurate. You are responsible for maintaining the confidentiality of your account credentials.',
        isEditing: false,
      },
      {
        id: 'tos-2',
        ...
        order: 2,
        content:
          'KartSeek provides a multi-service platform including Marketplace (e-commerce), Grocery, Restaurant, Pharmacy, Taxi & Rides, Hotel Booking, Doctor Appointments, and Healthcare services. Each module may have additional specific terms.',
        isEditing: false,
      },
      {
        id: 'tos-3',
        ...
        order: 3,
        content:
          'All orders are subject to acceptance and availability. Prices include applicable taxes unless stated otherwise. We accept UPI, credit/debit cards, net banking, mobile wallets, and cash on delivery (where available). Refunds are processed within 5-7 business days after approval.',
        isEditing: false,
      },
      {
        id: 'tos-4',
        ...
        order: 4,
        content:
          'Delivery timelines vary by location and product category. Standard delivery: 3-7 business days. Express delivery: 1-2 business days (where available). Same-day delivery available for grocery and restaurant orders in select cities.',
        isEditing: false,
      },
      {
        id: 'tos-5',
        ...
        order: 5,
        content:
          'Most marketplace products can be returned within 7-30 days (varies by category). Perishable goods (grocery, restaurant) must be reported within 24 hours. Refunds are processed to the original payment method.',
        isEditing: false,
      },
      {
        id: 'tos-6',
        ...
        order: 6,
        content:
          'Sellers agree to list only genuine products, maintain accurate stock levels, ship within committed timeframes, and comply with all applicable regulations.',
        isEditing: false,
      },
      {
        id: 'tos-7',
        ...
        order: 7,
        content:
          'All content on KartSeek — logos, trademarks, text, images, software — is the property of KartSeek or its licensors and is protected by intellectual property laws.',
        isEditing: false,
      },
      {
        id: 'tos-8',
        ...
        order: 8,
        content:
          'KartSeek acts as an intermediary platform. We are not liable for the quality, safety, or legality of items sold by third-party sellers, nor for the accuracy of seller listings.',
        isEditing: false,
      },
      {
        id: 'tos-9',
        ...
        order: 9,
        content:
          'Your privacy is important. Our Privacy Policy explains how we collect, use, and protect your personal data.',
        isEditing: false,
      },
      {
        id: 'tos-10',
        ...
        order: 10,
        content:
          'These Terms are governed by the laws of India. Disputes shall be resolved through arbitration in Mumbai, India, under the Indian Arbitration and Conciliation Act.',
        isEditing: false,
      },
    ],
  },
  cookies: {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 2,
        content:
          'Help us understand how visitors interact with our website by collecting anonymized usage data.\n\nExamples: Google Analytics (_ga, _gid), page views, scroll depth, click heatmaps, session duration.',
        isEditing: false,
      },
      {
        id: 'ck-3',
  ...
  grievance: {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 4,
        content:
          'This grievance redressal mechanism is established in compliance with the Information Technology Act, 2000, the IT (Intermediary Guidelines and Digital Media Ethics Code) Rules, 2021, and the Consumer Protection (E-Commerce) Rules, 2020.',
        isEditing: false,
      },
    ],
  },
    ...
    sections: [
      {
        ...
        title: 'Key Numbers',
        order: 1,
        content: '100M+ Customers | 50K+ Sellers | 8 Verticals | 500+ Cities',
        isEditing: false,
      },
      {
        id: 'abt-2',
        ...
        order: 2,
        content:
          'To democratize commerce by building a unified platform that empowers small businesses to reach millions of customers, while providing shoppers with the best selection, prices, and convenience — across marketplace, groceries, food delivery, pharmacy, travel, ride-hailing, healthcare, and more.',
        isEditing: false,
      },
      {
        id: 'abt-3',
      ...
      },
      {
        ...
        order: 4,
        content:
          'Founded in 2024, KartSeek started with a simple observation: Indian consumers were using 8-10 different apps for daily needs. We set out to build a single platform that unifies all these experiences.\n\nToday, KartSeek serves millions of customers across India, the UAE, Saudi Arabia, the UK, and the US, with a growing network of trusted sellers and service providers.',
        isEditing: false,
      },
    ],
  },
  ...
  press: {
    ...
    sections: [
      ...
      },
      {
        ...
        order: 2,
        content:
          'Download official KartSeek logos, brand guidelines, and media assets from our brand kit.',
        isEditing: false,
      },
      {
        id: 'prs-3',
        ...
        order: 3,
        content: 'For press inquiries, interviews, and media requests, contact press@kartseek.com',
        isEditing: false,
      },
    ],
  },
  ...
  investors: {
    ...
    sections: [
      ...
      },
      {
        ...
        title: 'Contact',
        order: 4,
        content: 'For investment, partnership, or financial inquiries: investors@kartseek.com',
        isEditing: false,
      },
    ],
  },
...
export default function StaticPageEditor({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const handleSave = async () => {
    ...
    try {
      const saveData = {
        ...
        // The editor is `req.user.id` on the server, never the body — an
        // `adminId` field here was silently ignored and, after the gateway's
        // validation pipe started rejecting undeclared fields, turned every
        // save into a 400 that this `catch` then reported as a fake success.
      };
      const res = await apiFetch<any>(`/admin/static-pages/${slug}`, {
        method: 'PUT',
        body: JSON.stringify(saveData),
      });
      if (res.page) {
        setPage((prev) =>
          prev ? { ...prev, version: res.page.version, updatedAt: res.page.updatedAt } : prev,
        );
      }
      setSuccessMsg('Page saved successfully! Changes are live on the website.');
      setPage((prev) =>
        prev ? { ...prev, sections: prev.sections.map((s) => ({ ...s, isEditing: false })) } : prev,
      );
      setTimeout(() => setSuccessMsg(''), 4000);
    } catch (err) {
      // A failed save used to be reported as "Page saved (local mode)" —
      // the admin believed their edit persisted, and it never did.
      setSaveError(err instanceof Error ? err.message : 'Could not save this page');
    } finally {
      setIsSaving(false);
    }
  };
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-slate-800 text-white px-4 py-2.5 rounded-xl text-sm font-bold hover:bg-slate-700 transition-colors"
          >
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden max-w-3xl mx-auto">
          <div
            className={`bg-gradient-to-r ${page.heroGradient} text-white py-10 px-8 text-center`}
          >
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-3">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-3 py-2 rounded-xl text-sm font-bold transition-colors ${page.isPublished ? 'bg-emerald-600 text-white hover:bg-emerald-700' : 'bg-amber-500 text-white hover:bg-amber-600'}`}
          >
      ...
      {/* Success */}
      {successMsg && (
        <div className="border rounded-xl p-3 flex items-center gap-2 text-sm font-medium bg-emerald-50 border-emerald-200 text-emerald-700">
          <CheckCircle className="w-4 h-4" /> {successMsg}
        </div>
      )}

      {/* Save error — the real one, not a fabricated success */}
      {saveError && (
      ...
      <div className="flex items-center gap-4 text-sm text-slate-500 flex-wrap">
        <span className="flex items-center gap-1">
          <Clock className="w-3.5 h-3.5" /> v{page.version}
        </span>
        <span className="flex items-center gap-1">
          <FileText className="w-3.5 h-3.5" /> {page.sections.length} sections
        </span>
        <span
          className={`flex items-center gap-1 font-semibold ${page.isPublished ? 'text-emerald-600' : 'text-amber-600'}`}
        >
          {page.isPublished ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                id="hero-icon"
                value={page.heroIcon}
                onChange={(e) => setPage({ ...page, heroIcon: e.target.value })}
            ...
            <div className="md:col-span-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                {GRADIENT_OPTIONS.map((g) => (
                  <button
                    key={g.value}
                    onClick={() => setPage({ ...page, heroGradient: g.value })}
            ...
            <div className="flex items-center justify-between px-5 py-3 bg-slate-50 border-b border-slate-200">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  ...
                  className={`p-1.5 rounded-lg transition-colors ${section.isEditing ? 'bg-blue-50 text-blue-600' : 'hover:bg-slate-100 text-slate-400'}`}
                  title="Edit"
                >
