...
function Overview({ franchiseId }: { franchiseId: string }) {
  ...
  const links = [
    { href: '/franchise/grocery/stores', label: 'Stores', desc: 'Every grocery store in your zone' },
    { href: '/franchise/grocery/orders', label: 'Orders', desc: 'Orders placed at those stores' },
    { href: '/franchise/grocery/products', label: 'Products', desc: 'Their combined catalogue' },
    { href: '/franchise/grocery/analytics', label: 'Analytics', desc: 'Revenue and order trend' },
  ];
