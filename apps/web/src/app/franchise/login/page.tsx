...
export default function FranchiseLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const redirect = params.get('redirect') || '/franchise';
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <Link href="/auth/forgot-password" className="text-teal-400 hover:text-teal-300 font-medium transition-colors">
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-6 text-center space-y-2">
            <p className="text-slate-600 text-sm">
              ...
              <Link href="/franchise/opportunity" className="text-teal-400 hover:text-teal-300 font-bold transition-colors">
                Apply Now →
              </Link>
            </p>
            <Link href="/" className="text-slate-600 hover:text-slate-400 text-xs transition-colors block">
