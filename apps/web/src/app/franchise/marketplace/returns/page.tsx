...
const kpis = [{ label: 'Total Returns', value: '137', change: '-5%' },{ label: 'Pending', value: '28', change: '-8%' },{ label: 'Refunded', value: '95', change: '+2%' },{ label: 'Return Rate', value: '3.6%', change: '-0.4%' }];
const columns = ['Return ID', 'Order', 'Customer', 'Product', 'Reason', 'Amount', 'Status'];
const rows = [{ rid: 'RT-501', oid: 'MO-8845', cust: 'Vikram T.', prod: 'Wireless Earbuds', reason: 'Defective', amt: '₹2,499', status: 'Refunded' },{ rid: 'RT-502', oid: 'MO-8890', cust: 'Sneha R.', prod: 'Dress (M)', reason: 'Wrong Size', amt: '₹1,850', status: 'Pending' },{ rid: 'RT-503', oid: 'MO-8912', cust: 'Anil M.', prod: 'Phone Case', reason: 'Not as described', amt: '₹450', status: 'Approved' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Track and manage product returns across your zone</p>
        </div>
