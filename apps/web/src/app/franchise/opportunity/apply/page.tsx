    ...
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white max-w-md w-full rounded-2xl shadow-xl p-8 text-center border border-slate-200">
          ...
          <Link href="/" className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-3 rounded-xl transition-colors inline-block">
            Return to Home
          </Link>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <div className="bg-slate-900 text-white py-6 px-4 md:px-8 border-b border-slate-800 shrink-0">
        <div className="max-w-5xl mx-auto flex justify-between items-center">
          ...
          <Link href="/franchise/opportunity" className="text-sm text-slate-400 hover:text-white transition-colors">Cancel Application</Link>
        </div>
      </div>
