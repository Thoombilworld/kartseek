    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4 mb-2">
        ...
        <div className="flex flex-col items-end gap-2">
          ...
          <Link href="/franchise/settings" className="text-xs font-bold text-indigo-600 hover:underline">Request Upgrade →</Link>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
          <div className="p-5 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
            ...
            <Link href="/franchise/vendors" className="text-xs text-teal-600 font-bold hover:underline flex items-center gap-1">View All <ArrowRight className="w-3 h-3" /></Link>
          </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden mt-6">
        <div className="p-5 border-b border-slate-200 flex justify-between items-center bg-slate-50/50">
          ...
          <Link href="/franchise/orders" className="text-xs text-teal-600 font-bold hover:underline">View All</Link>
        </div>
        <div className="divide-y divide-slate-100">
