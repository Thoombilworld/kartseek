...
const kpis = [{ label: 'Monthly Revenue', value: '₹12.4L', change: '+14%' },{ label: 'Avg Rating', value: '4.5', change: '+0.1' },{ label: 'Delivery Time', value: '32 min', change: '-4%' },{ label: 'Repeat Rate', value: '38%', change: '+5%' }];
const columns = ['Restaurant', 'Revenue', 'Orders', 'Avg Order', 'Rating', 'Growth'];
const rows = [{ r: 'Burger King', rev: '₹3.8L', o: '1,840', a: '₹520', rt: '4.5', g: '+12%' },{ r: 'Pizza Palace', rev: '₹2.9L', o: '1,520', a: '₹480', rt: '4.7', g: '+18%' },{ r: 'Sushi Kingdom', rev: '₹2.1L', o: '980', a: '₹680', rt: '4.9', g: '+22%' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Performance insights for restaurant operations</p>
        </div>
