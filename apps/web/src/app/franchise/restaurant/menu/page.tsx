...
const kpis = [{ label: 'Total Items', value: '3,280', change: '+8%' },{ label: 'Top Selling', value: 'Biryani', change: '' },{ label: 'Avg Price', value: '₹320', change: '+5%' },{ label: 'Veg Items', value: '45%', change: '+2%' }];
const columns = ['Item', 'Restaurant', 'Category', 'Price', 'Orders/Week', 'Rating', 'Status'];
const rows = [{ i: 'Chicken Biryani', r: 'Spice Garden', c: 'Main Course', p: '₹350', o: '420', rt: '4.8', s: 'Active' },{ i: 'Margherita Pizza', r: 'Pizza Palace', c: 'Pizza', p: '₹299', o: '380', rt: '4.6', s: 'Active' },{ i: 'Butter Chicken', r: 'Punjab Grill', c: 'Main Course', p: '₹380', o: '310', rt: '4.7', s: 'Active' }];

export default function MenuStatisticsPage() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Menu Statistics</h1>
          <p className="text-slate-400 mt-1">Menu performance across restaurants</p>
        </div>
