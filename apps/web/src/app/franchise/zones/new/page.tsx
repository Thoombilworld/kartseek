      ...
      <div className="max-w-2xl mx-auto p-4 md:p-8">
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <Link href="/franchise/zones" className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-colors">
              View All Zones
            </Link>
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/franchise/zones" className="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center hover:bg-slate-50 transition-colors">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex items-center justify-between pt-2">
          <Link href="/franchise/zones" className="text-sm text-slate-500 hover:text-slate-700 font-medium">Cancel</Link>
