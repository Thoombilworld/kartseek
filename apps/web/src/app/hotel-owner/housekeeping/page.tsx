...
import { Search, RefreshCw, Download, Filter, Sparkles } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Sparkles className="w-7 h-7 text-blue-600" />Housekeeping
          </h1>
          <p className="text-sm text-slate-500 mt-1">Manage room cleaning schedules</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Assigned To</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Priority</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Scheduled</th>
