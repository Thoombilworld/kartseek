...
import { Search, RefreshCw, Download, Filter, Wrench } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Wrench className="w-7 h-7 text-blue-600" />Maintenance
          </h1>
          <p className="text-sm text-slate-500 mt-1">Track maintenance requests</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Assigned</th>
