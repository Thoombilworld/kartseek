...
export const metadata: Metadata = buildMeta({
  title: 'Buy Again',
  description: 'Reorder what you have bought before on KARTSEEK Marketplace.',
  path: '/marketplace/buy-again',
  noIndex: true,
});

export default function BuyAgainLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
