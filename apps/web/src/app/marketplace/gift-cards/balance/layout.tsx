...
export const metadata: Metadata = buildMeta({
  ...
  description: 'Check the remaining balance on a KARTSEEK gift card.',
  path: '/marketplace/gift-cards/balance',
  noIndex: true,
});

export default function GiftCardsBalanceLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
