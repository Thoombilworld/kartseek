...
export const metadata: Metadata = buildMeta({
  title: 'Order Invoice',
  description: 'Tax invoice for a KARTSEEK Marketplace order.',
  path: '/marketplace/orders/[id]/invoice',
  noIndex: true,
});

export default function OrdersIdInvoiceLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
