...
export const metadata: Metadata = buildMeta({
  ...
  description: 'Raise a return request for a KARTSEEK Marketplace order.',
  path: '/marketplace/returns/new',
  noIndex: true,
});

export default function ReturnsNewLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
