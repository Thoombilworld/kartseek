        ...
        <div className="max-w-7xl mx-auto">
          <nav className="text-sm text-white/60 mb-3 flex items-center gap-1.5">
            ...
            {parentCategorySlug && (
              <>
                <ChevronRight className="w-3 h-3" />
                <Link href={`/marketplace/category/${parentCategorySlug}`} className="hover:text-white transition-colors">
        ...
        <div className="max-w-7xl mx-auto px-4 pt-4">
          <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 flex flex-col sm:flex-row sm:items-center gap-3">
            ...
            <div className="flex gap-2 shrink-0">
              <Link href={`/marketplace/subcategory/${id}`} className="bg-amber-600 hover:bg-amber-700 text-white text-xs font-bold px-4 py-2 rounded-lg transition-colors">
                Retry
              </Link>
              <Link href="/marketplace/category-list" className="border border-amber-300 text-amber-900 text-xs font-semibold px-4 py-2 rounded-lg hover:bg-amber-100 transition-colors">
                Browse categories
              </Link>
            </div>
          </div>
