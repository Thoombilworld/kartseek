...
import { Search, RefreshCw, Download, Filter, Stethoscope, Plus } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Stethoscope className="w-7 h-7 text-blue-600" />My Doctors
          </h1>
          <p className="text-sm text-slate-500 mt-1">Manage doctors in your practice</p>
        </div>
        <div className="flex gap-2">
          <a href="#" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-bold hover:bg-blue-700 transition-colors"><Plus className="w-4 h-4" />Add Doctor</a>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Specialization</th>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Patients Today</th>
