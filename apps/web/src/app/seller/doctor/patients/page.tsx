...
import { Search, RefreshCw, Download, Filter, Users } from 'lucide-react';
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Age</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Last Visit</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Condition</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Next Appointment</th>
            </tr>
          </thead>
