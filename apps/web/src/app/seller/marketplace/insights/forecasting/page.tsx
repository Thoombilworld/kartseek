...
/**
 * Demand Forecasting — not implemented on the backend.
 *
 * This page used to render hard-coded rows as though they were the seller's own
 * figures. There is no `GET /sellers/:id/analytics/forecasting` on the gateway, so nothing here was ever
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Projected demand by listing</p>
      </div>
