...
/**
 * Notification Preferences — not implemented on the backend.
 *
 * This page used to render hard-coded rows as though they were the seller's own
 * figures. There is no `GET /sellers/:id/settings/notifications` on the gateway, so nothing here was ever
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
          <Bell className="w-6 h-6 text-slate-400" aria-hidden />
          Notification Preferences
        </h1>
        <p className="text-sm text-slate-500 mt-1">Which alerts reach you, and how</p>
      </div>
