...
import { Search, RefreshCw, Download, Filter, ClipboardList } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <ClipboardList className="w-7 h-7 text-blue-600" />Pharmacy Inventory
          </h1>
          <p className="text-sm text-slate-500 mt-1">Track medicine stock and expiry</p>
        </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Batch</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Stock</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Expiry</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Days Left</th>
