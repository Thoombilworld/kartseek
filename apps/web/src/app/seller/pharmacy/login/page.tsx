...
import { Pill, Mail, Lock, Eye, EyeOff, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-black text-white">Pharmacy Login</h1>
          <p className="text-sm text-slate-400 mt-1">Sign in to your pharmacy dashboard</p>
        </div>
        ...
        <p className="text-center text-sm text-slate-400 mt-4">
          ...
          <Link href="/seller/pharmacy/register" className="text-blue-400 hover:text-blue-300 font-semibold">Register</Link>
        </p>
      </div>
    </div>
  );
