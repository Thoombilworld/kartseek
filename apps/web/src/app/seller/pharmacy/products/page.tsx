...
import { Search, RefreshCw, Download, Filter, Pill, Plus } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Pill className="w-7 h-7 text-blue-600" />Medicine Catalog
          </h1>
          <p className="text-sm text-slate-500 mt-1">Manage medicines and health products</p>
        </div>
        <div className="flex gap-2">
          <Link href="/seller/pharmacy/products/add" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-bold hover:bg-blue-700 transition-colors"><Plus className="w-4 h-4" />Add Medicine</Link>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Medicine</th>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Rx Required</th>
