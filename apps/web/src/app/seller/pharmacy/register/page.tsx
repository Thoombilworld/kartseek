 ...
 * `/seller/pharmacy/dashboard`. It called no API, so the account it appeared to
 ...
 * pharmacy module's entry point and hands over with the module already
 * selected.
 */
export default async function PharmacyRegisterPage({
  ...
  const target = new URLSearchParams({ module: 'pharmacy' });
