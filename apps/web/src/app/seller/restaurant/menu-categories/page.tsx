...
import { Search, RefreshCw, Download, Filter, Layers, Plus } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Layers className="w-7 h-7 text-blue-600" />Category Management
          </h1>
          <p className="text-sm text-slate-500 mt-1">Edit menu categories</p>
        </div>
