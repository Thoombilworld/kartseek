      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Edit className="w-7 h-7 text-blue-600" />Edit Menu Item
          </h1>
          <p className="text-sm text-slate-500 mt-1">Update menu item details</p>
        </div>
      </div>

      <form onSubmit={handleSubmit} className="bg-white border border-slate-200 rounded-xl p-6 space-y-5">
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-1.5" htmlFor="item-name">Item Name</label>
          <input id="item-name" type="text" placeholder="Menu item name"  className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-1.5" htmlFor="prep-time-min">Prep Time (min)</label>
          <input id="prep-time-min" type="number" placeholder="15"  className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
        <div>
          <label className="block text-sm font-semibold text-slate-700 mb-1.5" htmlFor="description">Description</label>
          <textarea id="description" rows={3} placeholder="Item description..." className="w-full border border-slate-200 rounded-lg px-4 py-2.5 text-sm resize-none outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
