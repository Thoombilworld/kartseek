...
import { Search, RefreshCw, Download, Filter, History } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <History className="w-7 h-7 text-blue-600" />Order History
          </h1>
          <p className="text-sm text-slate-500 mt-1">View past restaurant orders</p>
        </div>
