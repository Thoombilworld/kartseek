...
import { Search, RefreshCw, Download, Filter, UtensilsCrossed, ChefHat, CheckCircle, DollarSign } from 'lucide-react';
...
export default function RestaurantOrdersPage() {
  ...
  const filters = ["All","New","Preparing","Ready","Served","Delivered"];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <UtensilsCrossed className="w-7 h-7 text-blue-600" />Restaurant Orders
          </h1>
          <p className="text-sm text-slate-500 mt-1">Manage incoming food orders</p>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center"><UtensilsCrossed className="w-5 h-5 text-blue-600" /></div><div><p className="text-xs text-slate-500">Active Orders</p><p className="text-lg font-black text-slate-900">8</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center"><ChefHat className="w-5 h-5 text-amber-600" /></div><div><p className="text-xs text-slate-500">Preparing</p><p className="text-lg font-black text-slate-900">4</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-emerald-50 flex items-center justify-center"><CheckCircle className="w-5 h-5 text-emerald-600" /></div><div><p className="text-xs text-slate-500">Ready for Pickup</p><p className="text-lg font-black text-slate-900">3</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-violet-50 flex items-center justify-center"><DollarSign className="w-5 h-5 text-violet-600" /></div><div><p className="text-xs text-slate-500">Today's Revenue</p><p className="text-lg font-black text-slate-900">32,450</p></div></div>
        </div>
      </div>
