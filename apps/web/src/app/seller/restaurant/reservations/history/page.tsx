...
import { Search, RefreshCw, Download, Filter, CalendarCheck } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <CalendarCheck className="w-7 h-7 text-blue-600" />Reservation History
          </h1>
          <p className="text-sm text-slate-500 mt-1">Past table reservations</p>
        </div>
      ...
      <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Booking ID</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Guest</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Party Size</th>
