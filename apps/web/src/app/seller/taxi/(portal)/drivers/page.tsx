...
import { Search, RefreshCw, Download, Filter, Users, Radio, Car, Star, Plus } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-black text-slate-900 flex items-center gap-2">
            <Users className="w-7 h-7 text-blue-600" />Driver Management
          </h1>
          <p className="text-sm text-slate-500 mt-1">Manage your fleet drivers</p>
        </div>
        <div className="flex gap-2">
          <a href="#" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2.5 rounded-lg text-sm font-bold hover:bg-blue-700 transition-colors"><Plus className="w-4 h-4" />Add Driver</a>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center"><Users className="w-5 h-5 text-blue-600" /></div><div><p className="text-xs text-slate-500">Total Drivers</p><p className="text-lg font-black text-slate-900">24</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-emerald-50 flex items-center justify-center"><Radio className="w-5 h-5 text-emerald-600" /></div><div><p className="text-xs text-slate-500">Online Now</p><p className="text-lg font-black text-slate-900">18</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center"><Car className="w-5 h-5 text-amber-600" /></div><div><p className="text-xs text-slate-500">On Trip</p><p className="text-lg font-black text-slate-900">12</p></div></div>
        </div>
        <div className="bg-white border border-slate-200 rounded-xl p-4">
          <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-violet-50 flex items-center justify-center"><Star className="w-5 h-5 text-violet-600" /></div><div><p className="text-xs text-slate-500">Avg Rating</p><p className="text-lg font-black text-slate-900">4.7★</p></div></div>
        </div>
      </div>
        ...
        <table className="w-full text-sm">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr>
              ...
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Vehicle</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Rating</th>
              <th className="px-4 py-3 text-left font-semibold text-slate-500">Trips Today</th>
