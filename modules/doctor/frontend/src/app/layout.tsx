...
/**
 * Root layout for the doctor zone.
 *
...
// Carried over from the former app/doctor/layout.tsx. Every route in this
// zone is doctor, so that file had no distinct level left to occupy once the
// routes moved: its metadata moved here and its chrome became <DoctorShell>.
    ...
    >
      ...
      <body className="bg-slate-50 min-h-screen text-slate-900 antialiased">
        {/*
          ...
          <main id="main-content"> that the doctor chrome renders; it is not
