      ...
      <div className="max-w-2xl mx-auto p-4 md:p-8">
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-8 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            <Link href="/commissions" className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-2.5 rounded-lg text-sm font-bold transition-colors">
              View Commissions
            </Link>
            <Link href="/" className="bg-white hover:bg-slate-50 text-slate-700 px-6 py-2.5 rounded-lg text-sm font-bold border border-slate-200 transition-colors">
              Back to Dashboard
            </Link>
          </div>
        </div>
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
      ...
      <div className="flex items-center gap-4">
        <Link href="/commissions" className="w-10 h-10 bg-white border border-slate-200 rounded-xl flex items-center justify-center hover:bg-slate-50 transition-colors">
        ...
        <div className="lg:col-span-2">
          <div className="bg-white border border-slate-200 rounded-xl shadow-sm overflow-hidden">
            ...
            <div className="p-4 border-t border-slate-200 bg-slate-50/50 text-center">
              <Link href="/commissions" className="text-xs text-teal-600 font-bold hover:underline">View Full Ledger →</Link>
            </div>
          </div>
