...
const kpis = [{ label: 'Monthly Revenue', value: '₹15.2L', change: '+14%' },{ label: 'Appointments', value: '4,820', change: '+12%' },{ label: 'Telemedicine', value: '28%', change: '+8%' },{ label: 'Patient Satisfaction', value: '4.6', change: '+0.2' }];
const columns = ['Clinic', 'Revenue', 'Appointments', 'Doctors', 'Rating', 'Growth'];
const rows = [{ c: 'City Care Hospital', r: '₹3.2L', a: '1,350', d: '12', rt: '4.8', g: '+15%' },{ c: 'Apollo Clinic', r: '₹4.8L', a: '1,860', d: '18', rt: '4.7', g: '+12%' },{ c: 'HealthPlus', r: '₹1.4L', a: '840', d: '6', rt: '4.4', g: '+8%' }];
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-white">Doctor Analytics</h1>
          <p className="text-slate-400 mt-1">Healthcare performance insights</p>
        </div>
