...
const kpis = [{ label: 'Today Appts', value: '219', change: '+12%' },{ label: 'Completed', value: '185', change: '+10%' },{ label: 'Upcoming', value: '28', change: '+5%' },{ label: 'Cancellations', value: '6', change: '-15%' }];
const columns = ['Appt ID', 'Patient', 'Doctor', 'Clinic', 'Specialty', 'Time', 'Status'];
const rows = [{ id: 'AP-6001', p: 'Rahul S.', d: 'Dr. Patel', c: 'City Care', s: 'Cardiology', t: '10:00 AM', st: 'Completed' },{ id: 'AP-6002', p: 'Priya M.', d: 'Dr. Sharma', c: 'Apollo', s: 'ENT', t: '11:30 AM', st: 'In Progress' },{ id: 'AP-6003', p: 'Anil K.', d: 'Dr. Rao', c: 'HealthPlus', s: 'General', t: '2:00 PM', st: 'Scheduled' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Track medical appointments across clinics</p>
        </div>
