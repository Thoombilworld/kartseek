...
const kpis = [{ label: 'Total Clinics', value: '8', change: '+1' },{ label: 'Active', value: '6', change: '+1' },{ label: 'Total Doctors', value: '54', change: '+5' },{ label: 'Avg Rating', value: '4.5', change: '+0.2' }];
const columns = ['Clinic', 'Location', 'Doctors', 'Specializations', 'Today Appts', 'Revenue', 'Status'];
const rows = [{ c: 'City Care Hospital', l: 'Colaba', d: '12', s: 'General, Cardiology', a: '45', r: '₹3.2L', st: 'Active' },{ c: 'Apollo Clinic', l: 'Bandra', d: '18', s: 'Orthopedics, ENT', a: '62', r: '₹4.8L', st: 'Active' },{ c: 'HealthPlus', l: 'Andheri', d: '6', s: 'General, Gynecology', a: '28', r: '₹1.4L', st: 'Active' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Manage clinics registered in your zone</p>
        </div>
