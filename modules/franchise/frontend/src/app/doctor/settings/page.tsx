...
const kpis = [{ label: 'Commission', value: '10%', change: '0%' },{ label: 'Active Clinics', value: '6', change: '+1' },{ label: 'Telemedicine', value: 'Enabled', change: '' },{ label: 'Min Fee', value: '₹200', change: '0' }];
const columns = ['Setting', 'Value', 'Last Updated', 'Updated By'];
const rows = [{ s: 'Commission Rate', v: '10%', u: '2025-06-15', b: 'Admin' },{ s: 'Telemedicine', v: 'Enabled', u: '2025-05-20', b: 'Admin' },{ s: 'Min Consultation Fee', v: '₹200', u: '2025-06-01', b: 'Admin' },{ s: 'Prescription Validity', v: '30 days', u: '2025-04-10', b: 'System' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Configure healthcare module settings</p>
        </div>
