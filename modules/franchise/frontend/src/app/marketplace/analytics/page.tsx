...
const kpis = [{ label: 'GMV', value: '₹2.4Cr', change: '+18%' },{ label: 'Avg Order Value', value: '₹2,850', change: '+6%' },{ label: 'Conversion Rate', value: '3.8%', change: '+0.5%' },{ label: 'Repeat Buyers', value: '42%', change: '+4%' }];
const columns = ['Metric', 'This Month', 'Last Month', 'Change', 'Target'];
const rows = [{ m: 'Total Sales', tm: '₹85L', lm: '₹72L', ch: '+18%', t: '₹80L' },{ m: 'Orders', tm: '3,842', lm: '3,210', ch: '+20%', t: '3,500' },{ m: 'New Customers', tm: '1,250', lm: '980', ch: '+28%', t: '1,100' },{ m: 'Seller Revenue', tm: '₹68L', lm: '₹58L', ch: '+17%', t: '₹65L' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Sales trends and performance metrics for marketplace</p>
        </div>
