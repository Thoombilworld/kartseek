...
const kpis = [{ label: 'Commission Rate', value: '8%', change: '0%' },{ label: 'Active Sellers', value: '142', change: '+5' },{ label: 'Pending Approvals', value: '8', change: '+3' },{ label: 'Suspended', value: '2', change: '0' }];
const columns = ['Setting', 'Value', 'Last Updated', 'Updated By'];
const rows = [{ s: 'Base Commission', v: '8%', u: '2025-06-15', b: 'Admin' },{ s: 'Min Order Value', v: '₹200', u: '2025-05-20', b: 'Admin' },{ s: 'Free Delivery Above', v: '₹499', u: '2025-06-01', b: 'Admin' },{ s: 'Return Window', v: '7 days', u: '2025-04-10', b: 'System' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Configure marketplace policies for your franchise zone</p>
        </div>
