        ...
        <div className="max-w-7xl mx-auto relative z-10 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link href="/opportunity/apply" className="bg-teal-500 hover:bg-teal-400 text-slate-900 font-bold text-lg px-8 py-4 rounded-xl text-center transition-colors flex items-center justify-center gap-2">
      ...
      <div id="investment" className="bg-white py-20 px-4 md:px-8 border-y border-slate-200">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="bg-slate-50 rounded-3xl p-8 border border-slate-200">
            ...
            <Link href="/opportunity/apply" className="mt-8 w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-4 rounded-xl transition-colors flex items-center justify-center gap-2">
