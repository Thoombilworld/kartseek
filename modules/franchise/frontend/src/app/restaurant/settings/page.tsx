...
const kpis = [{ label: 'Commission', value: '15%', change: '0%' },{ label: 'Active Restaurants', value: '18', change: '+2' },{ label: 'Delivery Radius', value: '10 km', change: '0' },{ label: 'Min Order', value: '₹99', change: '0' }];
const columns = ['Setting', 'Value', 'Last Updated', 'Updated By'];
const rows = [{ s: 'Commission Rate', v: '15%', u: '2025-06-15', b: 'Admin' },{ s: 'Delivery Radius', v: '10 km', u: '2025-05-20', b: 'Admin' },{ s: 'Min Order Value', v: '₹99', u: '2025-06-01', b: 'Admin' },{ s: 'Free Delivery Above', v: '₹299', u: '2025-04-10', b: 'Admin' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Configure restaurant module policies</p>
        </div>
