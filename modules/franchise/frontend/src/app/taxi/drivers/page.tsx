...
const kpis = [{ label: 'Total Drivers', value: '185', change: '+12' },{ label: 'Online Now', value: '92', change: '+8' },{ label: 'On Ride', value: '45', change: '+15%' },{ label: 'Avg Rating', value: '4.4', change: '+0.1' }];
const columns = ['Driver', 'Vehicle', 'Status', 'Rides Today', 'Earnings', 'Rating', 'Zone'];
const rows = [{ d: 'Rajesh Kumar', v: 'Sedan - MH01AB1234', s: 'Online', r: '12', e: '₹2,450', rt: '4.8', z: 'South Mumbai' },{ d: 'Suresh P.', v: 'SUV - MH01CD5678', s: 'On Ride', r: '8', e: '₹3,200', rt: '4.6', z: 'Bandra' },{ d: 'Mohan T.', v: 'Hatchback - MH01EF9012', s: 'Offline', r: '5', e: '₹1,100', rt: '4.3', z: 'Andheri' }];
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-400 mt-1">Manage taxi drivers in your franchise zone</p>
        </div>
