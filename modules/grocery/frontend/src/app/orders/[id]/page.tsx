  ...
  return (
    <div className="max-w-2xl mx-auto py-6 px-4 space-y-5">
      ...
      <div className="flex items-center gap-3">
        <Link href="/grocery/orders" className="p-2 rounded-xl bg-white border border-slate-200 hover:bg-slate-50 transition-colors">
      ...
      <div className="flex gap-3">
        ...
        <Link href="/grocery/orders" className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-white border border-slate-200 text-slate-700 font-bold text-sm hover:bg-slate-50 transition-colors">{tr('Back to Orders')}</Link>
      </div>
    </div>
  );
}
