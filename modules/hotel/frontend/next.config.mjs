...
if (!process.env.NEXT_PUBLIC_ACTIVE_REGIONS) {
  console.warn(
    '[hotel-frontend] NEXT_PUBLIC_ACTIVE_REGIONS is not set — only the home market will be active. Copy .env.example to .env.local.',
  );
}
