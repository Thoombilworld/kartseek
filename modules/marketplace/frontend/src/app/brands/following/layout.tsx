...
export const metadata: Metadata = buildMeta({
  ...
  description: 'Brands you follow on KARTSEEK Marketplace.',
  path: '/marketplace/brands/following',
  noIndex: true,
});

export default function BrandsFollowingLayout({ children }: { children: React.ReactNode }) {
  return <>{children}</>;
}
