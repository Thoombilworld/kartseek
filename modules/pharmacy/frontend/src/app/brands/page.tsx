...
const BRANDS = [
  { id:'b1', name:'Cipla', emoji:'💊', tag:'India\'s #1', products:340, discount:'Up to 20% OFF', color:'from-blue-500 to-blue-700' },
  { id:'b2', name:'Dr. Reddy\'s', emoji:'🧪', tag:'Since 1984', products:280, discount:'Up to 15% OFF', color:'from-red-500 to-red-700' },
  { id:'b3', name:'Sun Pharma', emoji:'☀️', tag:'Global Leader', products:420, discount:'Up to 18% OFF', color:'from-amber-500 to-orange-600' },
  { id:'b4', name:'Dabur', emoji:'🌿', tag:'Ayurvedic', products:210, discount:'Up to 25% OFF', color:'from-green-500 to-emerald-700' },
  { id:'b5', name:'Himalaya', emoji:'🏔️', tag:'Natural Wellness', products:185, discount:'Up to 22% OFF', color:'from-teal-500 to-cyan-700' },
  { id:'b6', name:'Abbott', emoji:'⚗️', tag:'Science of Care', products:155, discount:'Up to 12% OFF', color:'from-purple-500 to-violet-700' },
  { id:'b7', name:'Pfizer', emoji:'🔬', tag:'Trusted Globally', products:120, discount:'Up to 10% OFF', color:'from-sky-500 to-blue-600' },
  { id:'b8', name:'Mankind', emoji:'💉', tag:'Affordable Healthcare', products:190, discount:'Up to 20% OFF', color:'from-rose-500 to-pink-700' },
  { id:'b9', name:'GSK', emoji:'🧬', tag:'Health Science', products:165, discount:'Up to 14% OFF', color:'from-emerald-500 to-green-700' },
  { id:'b10', name:'Lupin', emoji:'🧫', tag:'Quality First', products:145, discount:'Up to 16% OFF', color:'from-indigo-500 to-violet-600' },
  { id:'b11', name:'Biocon', emoji:'🔭', tag:'Biopharmaceuticals', products:88, discount:'Up to 11% OFF', color:'from-cyan-500 to-blue-600' },
  { id:'b12', name:'Zydus', emoji:'⚕️', tag:'Innovation', products:112, discount:'Up to 18% OFF', color:'from-fuchsia-500 to-purple-700' },
];
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button onClick={()=>setSort(sort==='name'?'products':'name')}
            ...
            <ArrowUpDown className="w-4 h-4" /> {sort === 'name' ? 'A–Z' : 'Popular'}
          </button>
        </div>
      </div>
