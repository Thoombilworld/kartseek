...
@Entity({ name: 'restaurant_promotions', schema: 'restaurant' })
export class RestaurantPromotion {
  ...
  @Column({
    ...
    scale: 2,
    default: 0,
    comment: 'Discount value (% or flat)',
  })
  ...
  @Column({
    ...
    scale: 2,
    default: 0,
    comment: 'Minimum order to qualify',
  })
  ...
  @Column({
    ...
    length: 50,
    nullable: true,
    comment: 'e.g. DELIVERY_ONLY, TAKEAWAY_ONLY',
  })
